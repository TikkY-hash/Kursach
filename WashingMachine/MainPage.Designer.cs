namespace WashingMachine
{
	partial class MainPage
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Пральна машина";
			// 
			// button1
			// 
			...
			this.button2.Location = new System.Drawing.Point(117, 352);
			...
			this.label2.Text = "Відкрити дверцята та покласти речі";
			// 
			// label3
			// 
			...
			this.label3.Text = "Дістати речі та закрити дверцята";
			// 
			// MainPage
			// 
